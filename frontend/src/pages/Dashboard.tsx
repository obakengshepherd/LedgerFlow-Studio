        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div className="flex gap-2">
            ...
            <p className="text-blue-800">
              <strong>Cryptographic Integrity:</strong> All entries hash-chained
              and immutable
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <p className="text-blue-800">
              <strong>Double-Entry Accounting:</strong> Ledger always balanced
              by design
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <p className="text-blue-800">
              <strong>Audit-Ready:</strong> Full traceability and compliance
              reporting
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <p className="text-blue-800">
              <strong>RBAC Enabled:</strong> Role-based access control for all
              operations
            </p>
          </div>
        </div>
