    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Immutable append-only financial ledger with cryptographic integrity
        </p>
      </div>
      ...
      {integrityData && (
        <div
          className={`rounded-xl border-2 p-6 ${integrityData.valid ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}`}
        >
          ...
          <p
            className={integrityData.valid ? "text-green-700" : "text-red-700"}
          >
            {integrityData.totalEntries} entries verified •{" "}
            {integrityData.errors.length} errors
          </p>
        </div>
      )}
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Each entry is cryptographically linked via SHA-256 hashing
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-medium rounded-full ${entry.type === "DEBIT" ? "bg-red-100 text-red-800" : "bg-green-100 text-green-800"}`}
                    >
                      {entry.type}
                    </span>
                ...
                <div className="text-right ml-4">
                  <div
                    className={`text-lg font-bold ${entry.type === "DEBIT" ? "text-red-600" : "text-green-600"}`}
                  >
                    {entry.type === "DEBIT" ? "-" : "+"}R{" "}
