...
export class LedgerController {
  ...
  @ApiOperation({
    ...
    description:
      "Creates a balanced debit-credit transaction in the immutable ledger",
  })
  @ApiResponse({
    status: 201,
    description: "Transaction created successfully",
  })
  async createTransaction(@Body() dto: CreateDoubleEntryDto, @Request() req) {
  ...
  @ApiOperation({
    ...
    description:
      "Validates the cryptographic hash chain and detects any tampering",
  })
  @ApiResponse({
    status: 200,
